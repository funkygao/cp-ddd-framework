...
visualize-showcase:
	@mvn io.github.dddplus:dddplus-maven-plugin:model -DrootDir=./dddplus-test/src/test/java/ddd/plus/showcase/wms/ -DpkgRef=doc/showcase/pkgref.dot -DcallGraph=./doc/showcase/callgraph.dot -DplantUml=./doc/showcase/wms.svg -Dencapsulation=./doc/showcase/encapsulation.txt -DtextModel=./doc/showcase/wms.txt
